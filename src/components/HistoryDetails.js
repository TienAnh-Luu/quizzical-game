...
export default function HistoryDetails({name, score, noQuiz, date}) {
  return (
    <section className="history-details">
      <section className='hd-leftSection'>
        ...
        <div className='hd-info'>
            ...
            <div className='hd-correctionContainer'>
                ...
                <div className='hd-correction'>Score: {score}/{noQuiz}</div>
            </div>
      ...
      <i className="fa-solid fa-xmark hd-rightSection"></i>
    </section>
  );
}
